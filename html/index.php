<?php include 'header.php'; ?>
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            <img src="../images/tm1.png" alt="Campus Paris">
            <div class="text-overlay">
                <div class="quote-icon">"</div>
                <p class="main-quote">Les laboratoires de recherche et le matériel de pointe m'ont permis de concrétiser
                    mes projets d'IA. Une école à la pointe de l'innovation.</p>
                <p class="student-credit"><strong>Thomas M.</strong> | Promo 2025 - Cybersécurité</p>
            </div>
        </div>

        <div class="mySlides fade">
            <img src="../images/tm2.png" alt="Campus Paris">
            <div class="text-overlay">
                <div class="quote-icon">"</div>
                <p class="main-quote">Grâce au réseau des 150 entreprises partenaires, j'ai décroché mon alternance dans
                    une Big Tech en seulement 10 jours. Un vrai tremplin.</p>
                <p class="student-credit"><strong>Quang Hai Nguyen</strong> | Promo 2024 - Data Science</p>
            </div>
        </div>

        <div class="mySlides fade">
            <img src="../images/tm3.png" alt="Campus Bordeaux">
            <div class="text-overlay">
                <div class="quote-icon">"</div>
                <p class="main-quote">L'esprit d'entraide et la richesse de la vie associative rendent le campus unique.
                    On y apprend autant humainement que techniquement.</p>
                <p class="student-credit"><strong>Nicolas K.</strong> | Promo 2026 - Software Engineering</p>
            </div>
        </div>
